...
import { Badge, Box, Button, Flex, Grid, GridItem, Heading, HStack, Image, Stack, Text, VStack } from "@chakra-ui/react"
...
function ArticleCard({ post }: { post: BlogPostList }) {
    ...
    return <Box
        ...
        transition="all 0.2s"
    >
        <Grid templateColumns={{ base: "1fr", md: "3fr 2fr" }} gap={3} alignItems="center">
...
export default function HomeChakraUi() {
    ...
    const { img, title, content, author, tags, publishedAt, readTime } = detailedPost
    return <Provider>
        <VStack gap={8} align="stretch">
            <Grid templateColumns={{ base: "1fr", lg: "3fr 2fr" }} gap={8}>
                ...
                <GridItem>
                    ...
                    >
                        ...
                        <GridItem >
                            ...
                            <Heading as="h1" size="4xl" mb={4} fontFamily="serif" fontWeight="semibold" lineHeight="1.2">
                                {title}
                            </Heading>
                ...
                <GridItem>
                    <VStack gap={12} align="stretch" mt={8}>
                        <VStack bg="gray.100" p={'32px'} gap={4} align="stretch" display={{ base: 'none', lg: 'inherit' }}>
                            <Heading as="h2" size="4xl" fontFamily="serif" fontWeight="medium" lineHeight="1.2">Stay Informed</Heading>
                            <Text>Get the best journalism every day with plans starting at less than $2/week. Cancel anytime.</Text>
                            <Button bg="teal.700" color="white" _hover={{ bg: "teal.800" }} fontWeight="semibold">Subscribe</Button>
                        </VStack>
            ...
            >
                <VStack p={8} align="start" gap={4}>
                    ...
                    <Text>
                        Get the best jorunalism every day with plans starting at less than $2/week.{" "}
                        <Box as="span" fontStyle="italic">Cancel anytime.</Box>
                    </Text>
                    <Button bg="teal.700" color="white" _hover={{ bg: "teal.800" }} rounded="none" fontWeight="semibold">Subscribe</Button>
                </VStack>
                <Flex gridColumn={["auto", "3"]} alignItems="flex-end" justifyContent="flex-end" pr={8}>
